...
hora2 << endl << " Hoy " << dia_semana[time->tm_wday] << ", "<< time->tm_mday << " de " << mes[time->tm_mon] << " del " << year << endl << time->tm_hour << ":" << time->tm_min << ":" << time->tm_sec << endl;
...
hora3 <<endl<< "Hoy " << dia_semana[time->tm_wday] << ", "<< time->tm_mday << " de " << mes[time->tm_mon] << " del " << year << endl << time->tm_hour << ":" << time->tm_min << ":" << time->tm_sec << endl;
...
minorista << endl << " CODIGO DEL CLIENTE " << auxCodigoa << " " << codigoa << " PROMEDIO DE COMPRA " << compra << endl; 
...
mayorista << endl << " CODIGO DEL CLIENTE " << auxCodigoa << " "  << " PROMEDIO DE COMPRA " << compra << endl; 
} else{
        cout<<"Error, el Archivo No se Pudo Abrir o No ha sido Creado"<<endl;
    }
 mayorista.close();   
...
aux<<codigoa<<"  "<<primernombre<<"  "<<segundonombre<<"  "<<primerapellido<<"  "<<segundoapellido<<"  "<<nit<<"  "<<compra<<"  "<<edad<<"  "<<endl; 
    ...
    rename("modnit.txt","clientealeatorio.txt");
 }
...
cout<<"                 __________________________"<<endl;
cout << "                 CODIGO GENERADO:     " << codigoa<<endl;
cout << "                 NOMBRES:             " << primernombre <<" "<< segundonombre<< endl;
cout << "                 APELLIDOS:           " << primerapellido << "  " << segundoapellido << endl; 
cout << "                 NIT DEL CLIENTE:     " << nit << endl; 
cout << "                 CANTIDAD CONSUMIDA Q." << compra <<".00"<<endl; 
...
int auxClavea=0;
auxa.open("deletealeatorio.txt",ios::out);
lectura.open("clientealeatorio.txt",ios::in);
...
lectura.close();
remove("clientealeatorio.txt");
rename("deletealeatorio.txt","clientealeatorio.txt");
}
...
void modificacionesminoristanombre(){
    ...
    int auxClave=0;
    aux.open("modminorista.txt",ios::out);
    lectura.open("clienteminorista.txt",ios::in);
    if(aux.is_open() && lectura.is_open()){
        cout<<"             INGRESE LA CLAVE DEL CLIENTE A MODIFICAR-------> ";
        cin>>auxClave;
...
aux<<codigominorista<<"  "<<nombreminorista1<<"  "<<nombreminorista2<<"  "<<apellidominorista1<<"  "<<apellidominorista2<<"  "<<nitminorista<<"  "<<compraminorista<<"  "<<endl; 
    ...
    rename("modminorista.txt","clienteminorista.txt");
 }
...
void modificacionesnitminorista(){
    ...
    int auxClave=0;
    aux.open("nitminorista.txt",ios::out);
    lectura.open("clienteminorista.txt",ios::in);
    if(aux.is_open() && lectura.is_open()){
        cout<<"              INGRESE LA CLAVE DEL CLIENTE A MODIFICAR--------> ";
        cin>>auxClave;
...
aux<<codigominorista<<"  "<<nombreminorista1<<"  "<<nombreminorista2<<"  "<<apellidominorista1<<"  "<<apellidominorista2<<"  "<<nitminorista<<"  "<<compraminorista<<"  "<<endl; 
    ...
    lectura.close();
    remove("clienteminorista.txt");
    rename("nitminorista.txt","clienteminorista.txt");
 }
...
bool encontrado=false;
int auxClavea=0;
auxa.open("deleteminorista.txt",ios::out);
lectura.open("clienteminorista.txt",ios::in);
if(auxa.is_open() && lectura.is_open()){
cout<<"                      INGRESE EL CODIGO DEL CLIENTE A ELIMINAR----------> ";
cin>>auxClavea;
...
lectura.close();
remove("clienteminorista.txt");
rename("deleteminorista.txt","clienteminorista.txt");
}
...
void modificacionesmayoristanombre(){
    ...
    int auxClave=0;
    aux.open("modmayorista.txt",ios::out);
    lectura.open("clientemayorista.txt",ios::in);
    if(aux.is_open() && lectura.is_open()){
        cout<<"               INGRESE LA CLAVE DEL CLIENTE A MODIFICAR: ";
        cin>>auxClave;
...
aux<<codigomayorista<<"  "<<nombremayorista1<<"  "<<nombremayorista2<<"  "<<apellidomayorista1<<"  "<<apellidomayorista2<<"  "<<nitmayorista<<"  "<<compramayorista<<"  "<<endl; 
    ...
    rename("modmayorista.txt","clientemayorista.txt");
 }
...
void modificacionesnitmayorista(){
    ...
    int auxClave=0;
    aux.open("mayoristanit.txt",ios::out);
    lectura.open("clientemayorista.txt",ios::in);
    if(aux.is_open() && lectura.is_open()){
        cout<<"              INGRESE LA CLAVE DEL CLIENTE A MODIFICAR-------> ";
        cin>>auxClave;
...
aux<<codigomayorista<<"  "<<nombremayorista1<<"  "<<nombremayorista2<<"  "<<apellidomayorista1<<"  "<<apellidomayorista2<<"  "<<nitmayorista<<"  "<<compramayorista<<"  "<<endl; 
    ...
    lectura.close();
    remove("clientemayorista.txt");
    rename("mayoristanit.txt","clientemayorista.txt");
 }
...
bool encontrado=false;
int auxClavea=0;
auxa.open("deletemayorista.txt",ios::out);
lectura.open("clientemayorista.txt",ios::in);
if(auxa.is_open() && lectura.is_open()){
cout<<"                   INGRESE EL CODIGO DEL CLIENTE A ELIMINAR---------> " ;
cin>>auxClavea;
...
lectura.close();
remove("clientemayorista.txt");
rename("deletemayorista.txt","clientemayorista.txt");
}
